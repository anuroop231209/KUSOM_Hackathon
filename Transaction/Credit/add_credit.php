...
<<<<<<< HEAD:Transaction/Credit/add_credit.html
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"></script>
=======
    <link rel="stylesheet" href="../Sidebar/styles.css">
    <script src="https://cdn.jsdelivr.net/npm/axios/dist/axios.min.js"
>>>>>>> 6358566be30c8538758971ef037aeb229616ef7e:Transaction/Credit/add_credit.php
</head>
<body id="body-pd">
<?php
...
?>
    <div class="container">
        <div class="new-credits">x
         <h2>New Credit</h2>
            <form id="credit-form" method="post" action="uploadnewcredit.php">
